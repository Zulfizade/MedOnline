  ...
  return (
    <div className={style.services}>
      <div className={style.service}>
        <i className={`fa-brands fa-rocketchat ${style.icon}`}></i>
      ...
      <div className={style.service}>
        <i className={`fa-solid fa-file-medical ${style.icon}`}></i>
      ...
      <div className={style.service}>
        <i className={`fa-solid fa-headset ${style.icon}`}></i>
      ...
      <div className={style.service}>
        <i className={`fa-solid fa-lock ${style.icon}`}></i>
